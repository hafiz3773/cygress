...
<!--                    <a class="btn btn-danger btn-sm me-2" href="/en/site/delete?id=20" data-confirm="Are you sure you want to delete this item?" data-method="post">Delete</a>-->
                    <a class="btn btn-danger btn-sm me-2" href="<?=Url::to(['site/delete?id='.$model->id])?>" data-confirm="Are you sure you want to delete this profile user?" data-method="post">Delete User</a>
