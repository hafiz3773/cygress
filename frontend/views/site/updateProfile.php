...
<style>
    ...
    input, textarea {color: #ff750f !important;}
</style>
...
<section id="services" class="services section mt-5">
    ...
    <div class="container section-title mt-0 mt-sm-4" data-aos="fade-up">
        <h2><?=Yii::t('app','register_p01')?></h2>
        <p style="font-size: 18px"><?=Yii::t('app','register_p02')?></p>
        ...
        <div class="row gy-5 mx-0 mx-sm-5 mb-4">
            ...
            <div class="col-xl-12 col-md-12 p-0 p-sm-4 mt-0" data-aos="zoom-in" data-aos-delay="300">
                <div class="service-item">
                    ...
                    <div id="signup_form1" class="details position-relative p1 px-1 px-sm-4 d-none">
                        <div class="icon">
                    ...
                    <div id="signup_form2" class="details position-relative p1 px-1 px-sm-4 d-nonee">
                        <div class="icon">
                            <i class="bi bi-broadcast"></i>
                        </div>
                        <div class="icon">
                        ...
                        <div class="card border-secondaryxxx mb-3 aos-init aos-animate d-none" data-aos="zoom-in" data-aos-delay="100" style="">
                            <div class="card-header" style="text-align: left"><?=Yii::t('app','register_pt1')?></div>
                            <div class="card-body text-secondary">
                                <p class="text-start"><?=Yii::t('app','register_p16')?>rrrr</p>
                            </div>
                        </div>
                        <div class="card border-secondaryxxx mb-3" style="">
                            ...
                            <div class="card-body text-secondary">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <?= $form->field($model, 'email')->textInput(['placeholder' => Yii::t('app', 'email'),'disabled' => true])->label(Yii::t('app','email')) ?>
                                    </div>
<!--                                    <div class="col-md-6">-->
                                        <?php //= $form->field($model, 'password')->passwordInput(['placeholder' => Yii::t('app', 'password')])->label(Yii::t('app','password')) ?>
<!--                                    </div>-->
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <a href="<?=\yii\helpers\Url::to(['site/profile'])?>" class="btn btn-light">Cancel</a>
